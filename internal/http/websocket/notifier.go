...
func (n *Notifier) NotifyDeliveryStatusUpdated(event events.DeliveryStatusUpdated) error {
	msg := Message{
...
func (n *Notifier) NotifyTaskStatusUpdated(event events.TaskStatusUpdated) error {
	msg := Message{
