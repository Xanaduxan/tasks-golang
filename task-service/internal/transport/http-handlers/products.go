...
import (
	...
	products2 "github.com/Xanaduxan/tasks-golang/task-service/internal/service/products"
...
var productService *products2.Service

func SetProductService(s *products2.Service) { productService = s }
...
func (req CreateProductRequest) Validate() error {
	if req.Name == "" || req.Price.LessThanOrEqual(decimal.Zero) {
		return products2.ErrInvalidInput
	}
	return nil
}
