...
import (
	...
	group_members2 "github.com/Xanaduxan/tasks-golang/task-service/internal/service/group_members"
...
var groupMemberService *group_members2.GroupMemberService

func SetGroupMemberService(s *group_members2.GroupMemberService) {
...
func (req CreateGroupMemberRequest) Validate() error {
	if req.UserID == uuid.Nil {
		return group_members2.ErrInvalidInput
	}
	return nil
}
