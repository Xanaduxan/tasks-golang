...
const file_proto_task_v1_task_proto_rawDesc = "" +
	...
	"\x05tasks\x18\x01 \x03(\v2\r.task.v1.TaskR\x05tasks2\xd6\x01\n" +
	"\vTaskService\x12E\n" +
	"\n" +
	...
	"\tListTasks\x12\x19.task.v1.ListTasksRequest\x1a\x1a.task.v1.ListTasksResponseB9Z7github.com/Xanaduxan/tasks-golang/pkg/pb/task/v1;taskv1b\x06proto3"
...
var file_proto_task_v1_task_proto_depIdxs = []int32{
	...
	2, // 5: task.v1.TaskService.CreateTask:output_type -> task.v1.CreateTaskResponse
	4, // 6: task.v1.TaskService.GetTask:output_type -> task.v1.GetTaskResponse
	6, // 7: task.v1.TaskService.ListTasks:output_type -> task.v1.ListTasksResponse
